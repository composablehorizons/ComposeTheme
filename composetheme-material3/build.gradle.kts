...
val publishVersion = "1.2.0-alpha"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposeThemeMaterial3"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.composetheme.material3"
    compileSdk = 34
    defaultConfig {
        minSdk = 21
        targetSdk = 34
    ...
    publishing {
        publications {
            withType<MavenPublication> {
                ...
                pom {
                    name.set("Compose Theme Material 3 extensions")
